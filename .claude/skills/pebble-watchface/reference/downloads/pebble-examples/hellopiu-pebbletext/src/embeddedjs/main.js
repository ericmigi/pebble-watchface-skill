...
const textStyle = new Style({ font:"bold 14px Gothic", left:10, right:10, top:15, bottom:15 });
...
const otherStyle = new Style({ font:"black 30px Bitham", color:screen.color ? ["blue","red"] : ["black","black"] });
